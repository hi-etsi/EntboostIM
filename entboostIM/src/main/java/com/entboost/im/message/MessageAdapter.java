...
public class MessageAdapter extends BaseAdapter {
	...
	public final static int UserDataType_1_Bytes_PIC = ChatRoomRichMsg.CHATROOMRICHMSG_TYPE_USER_DATA + 1;

	public final static int UserDataType_2_Bytes_AUDIO =ChatRoomRichMsg.CHATROOMRICHMSG_TYPE_USER_DATA + 2;

	public final static int  UserDataType_3_Bytes_FILE = ChatRoomRichMsg.CHATROOMRICHMSG_TYPE_USER_DATA + 3;
